...
export class RideController {
  ...
  async create(@Body() createRideDto: CreateRideDto, @Res() response): Promise<RideResponseDto> {
    try{
  ...
  async findAll(@Res() response): Promise<RideResponseDto[]> {
    try{
      ...
      const rides = await Promise.all(
        ridesModel.map(ride => ride.toDTO())
      );
  ...
  async findOne(@Param('id') id: string, @Res() response): Promise<RideResponseDto> {
    try{
  ...
  async update(@Param('id') id: string, @Body() updateRideDto: UpdateRideDto, @Res() response): Promise<RideResponseDto> {
    try{
  ...
  async remove(@Param('id') id: string, @Res() response): Promise<RideResponseDto> {
    try{
  ...
  async getDriverActiveRides(@Req() req, @Res() response): Promise<RideResponseDto[]> {
    try{
      const userId = req.user.sub;
      const userDriverActivesHistoryModel = await this.rideService.getDriverActiveRides(userId);
  ...
  async getMemberActiveRides(@Req() req, @Res() response): Promise<RideResponseDto[]> {
    try{
      const userId = req.user.sub;
      const userMemberActivesHistoryModel = await this.rideService.getMemberActiveRides(userId);
  ...
  async getDriverHistory(@Req() req, @Res() response): Promise<RideResponseDto[]> {
    try{
      const userId = req.user.sub;
      const userDriverHistoryModel = await this.rideService.getDriverHistory(userId);
  ...
  async getMemberHistory(@Req() req, @Res() response): Promise<RideResponseDto[]> {
    try{
      const userId = req.user.sub;
      const userMemberHistoryModel = await this.rideService.getMemberHistory(userId);
  ...
  async getUserHistory(@Req() req, @Res() response): Promise<RideResponseDto[]> {
    try{
      const userId = req.user.sub;
